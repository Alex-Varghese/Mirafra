...
void rdump(FILE * dumpsim_file) {                               
   ...
   for (k = 0; k < MIPS_REGS; k++)
    printf("R%d:  0x%08x : %d\n", k, CURRENT_STATE.REGS[k], CURRENT_STATE.REGS[k]);
    printf("HI:   0x%08x : %d\n", CURRENT_STATE.HI, CURRENT_STATE.HI);
    printf("LO:   0x%08x : %d\n", CURRENT_STATE.LO, CURRENT_STATE.LO);
    printf("\n");
     ...
     for (k = 0; k < MIPS_REGS; k++)
      fprintf(dumpsim_file, "R%d:  0x%08x : %d\n", k, CURRENT_STATE.REGS[k], CURRENT_STATE.REGS[k]);
     fprintf(dumpsim_file, "HI:   0x%08x : %d\n", CURRENT_STATE.HI, CURRENT_STATE.HI);
     fprintf(dumpsim_file, "LO:   0x%08x : %d\n", CURRENT_STATE.LO, CURRENT_STATE.LO);
     fprintf(dumpsim_file, "\n");
  }
